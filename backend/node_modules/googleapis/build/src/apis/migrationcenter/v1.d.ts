...
export declare namespace migrationcenter_v1 {
    ...
    export class Resource$Projects$Locations$Reportconfigs$Reports {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        artifactLink(params: Params$Resource$Projects$Locations$Reportconfigs$Reports$Artifactlink, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        artifactLink(params?: Params$Resource$Projects$Locations$Reportconfigs$Reports$Artifactlink, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ReportArtifactLink>>;
        artifactLink(params: Params$Resource$Projects$Locations$Reportconfigs$Reports$Artifactlink, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        artifactLink(params: Params$Resource$Projects$Locations$Reportconfigs$Reports$Artifactlink, options: MethodOptions | BodyResponseCallback<Schema$ReportArtifactLink>, callback: BodyResponseCallback<Schema$ReportArtifactLink>): void;
        artifactLink(params: Params$Resource$Projects$Locations$Reportconfigs$Reports$Artifactlink, callback: BodyResponseCallback<Schema$ReportArtifactLink>): void;
        artifactLink(callback: BodyResponseCallback<Schema$ReportArtifactLink>): void;
        /**
         * Creates a report.
         * @example
         * ```js
