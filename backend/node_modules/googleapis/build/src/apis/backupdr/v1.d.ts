...
export declare namespace backupdr_v1 {
    ...
    export class Resource$Projects$Locations$Backupvaults$Datasources$Backups {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchForResourceType(params: Params$Resource$Projects$Locations$Backupvaults$Datasources$Backups$Fetchforresourcetype, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchForResourceType(params?: Params$Resource$Projects$Locations$Backupvaults$Datasources$Backups$Fetchforresourcetype, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchBackupsForResourceTypeResponse>>;
        fetchForResourceType(params: Params$Resource$Projects$Locations$Backupvaults$Datasources$Backups$Fetchforresourcetype, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetchForResourceType(params: Params$Resource$Projects$Locations$Backupvaults$Datasources$Backups$Fetchforresourcetype, options: MethodOptions | BodyResponseCallback<Schema$FetchBackupsForResourceTypeResponse>, callback: BodyResponseCallback<Schema$FetchBackupsForResourceTypeResponse>): void;
        fetchForResourceType(params: Params$Resource$Projects$Locations$Backupvaults$Datasources$Backups$Fetchforresourcetype, callback: BodyResponseCallback<Schema$FetchBackupsForResourceTypeResponse>): void;
        fetchForResourceType(callback: BodyResponseCallback<Schema$FetchBackupsForResourceTypeResponse>): void;
        /**
    ...
    export class Resource$Projects$Locations$Datasourcereferences {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Datasourcereferences$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Datasourcereferences$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListDataSourceReferencesResponse>>;
        list(params: Params$Resource$Projects$Locations$Datasourcereferences$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Datasourcereferences$List, options: MethodOptions | BodyResponseCallback<Schema$ListDataSourceReferencesResponse>, callback: BodyResponseCallback<Schema$ListDataSourceReferencesResponse>): void;
        list(params: Params$Resource$Projects$Locations$Datasourcereferences$List, callback: BodyResponseCallback<Schema$ListDataSourceReferencesResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListDataSourceReferencesResponse>): void;
    }
